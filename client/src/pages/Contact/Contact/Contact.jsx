    ...
    <section>
      ...
      <div className="mb-12">
        <div>
          ...
          <div className="w-[90%] mx-auto flex flex-col md:flex-row justify-center items-center gap-8">
            <div className="w-full text-center md:flex-1 border">
              <div className="bg-[#D1A054] flex justify-center py-3 px-12">
                <svg
              ...
              <div className="bg-[#F3F3F3] mb-4 mx-4 py-8">
        ...
        />
        <div className="md:w-[60%] mx-auto bg-[#F3F3F3] p-12">
          <form
            onSubmit={(e) => {
              e.preventDefault();
            }}
            className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-7"
          >
            <div>
              <label className="text-xl font-semibold">Name*</label> <br />
              <input
                className="w-full input rounded-none outline-none"
                type="text"
                name="name"
                id="name"
            ...
            <div className="md:col-span-2">
              ...
              <br />
              <textarea
                className="w-full input rounded-none outline-none h-[100px] md:h-[200px]"
                name="name"
                id="message"
            ...
            <div className="flex justify-center md:col-span-2">
              <button
                type="submit"
                className="bg-gradient-to-r from-[#835D23] to-[#B58130] flex btn text-white"
              >
